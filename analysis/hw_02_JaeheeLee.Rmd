...
civil_war_data %>%  
  ...
  mutate(year_count = str_count(Date, year_regex))->civil_war_data_1
```
...
civil_war_data_1 %>%  
  ...
  mutate(month_count = str_count(Date, month_regex)) -> civil_war_data_2
```
...
civil_war_data_2 %>%  
  ...
  mutate(multiple_days = if_else(hyphen == "TRUE",  "TRUE", "FALSE")) -> civil_war_data_3
